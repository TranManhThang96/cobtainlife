    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-sm-6 col-lg-4 mb-lg-0 mb-4">
                <h3 class="headingVI fwEbold text-uppercase mb-7">Liên hệ</h3>
                <ul class="list-unstyled footerContactList mb-3">
                    <li class="mb-3 d-flex flex-nowrap pr-xl-20 pr-0"><span class="icon icon-place mr-3"></span>
                        <address class="fwEbold m-0">{{$configs->store_address['value']}}</address>
                    </li>
                    <li class="mb-3 d-flex flex-nowrap"><span class="icon icon-phone mr-3"></span> <span class="leftAlign"><a href="javascript:void(0);">{{$configs->store_hotline['value']}}</a></span></li>
                    <li class="email d-flex flex-nowrap"><span class="icon icon-email mr-2"></span> <span class="leftAlign"><a href="javascript:void(0);">{{$configs->store_email['value']}}</a></span></li>
                </ul>
                <ul class="list-unstyled followSocailNetwork d-flex flex-nowrap">
                    <li class="fwEbold mr-xl-11 mr-md-8 mr-3">Follow us:</li>
                    <li class="mr-xl-6 mr-md-5 mr-2"><a href="{{$configs->store_facebook_url['value']}}" class="fab fa-facebook-f" target="_blank"></a></li>
                    <li class="mr-xl-6 mr-md-5 mr-2"><a href="{{$configs->store_twitter_url['value']}}" class="fab fa-twitter"></a></li>
                    <li class="mr-xl-6 mr-md-5 mr-2"><a href="{{$configs->store_instagram_url['value']}}" class="fab fa-instagram"></a></li>
