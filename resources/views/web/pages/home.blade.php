		...
		<main>
			...
			<section class="bannerBlockHolder position-relative">
				<div class="slick-fade">
					<div>
						<!-- align -->
						<div class="align w-100 d-flex align-items-center bgCover" style="background-image: url(https://placehold.it/1920x900)">
					...
					<div>
						<!-- align -->
						<div class="align w-100 bgCover" style="background-image: url(https://placehold.it/1920x900);">
					...
					<div class="col-12 col-sm-6 col-lg-3 featureCol position-relative mb-6">
						<div class="border">
							<div class="imgHolder position-relative w-100 overflow-hidden">
								<img src="https://placehold.it/270x300" alt="image description" class="img-fluid w-100">
			...
			<div class="categorySecBlock overflow-hidden pt-xl-9 pb-xl-6 px-xl-17 px-0 pt-lg-10 pb-lg-4 pt-md-8 pb-md-2 pt-5">
				...
				<div class="masonryHolder">
					...
					<div class="grid-item mb-6 px-3">
						<div class="itemCol">
							<div class="position-relative">
								<img src="https://placehold.it/410x845" alt="image description" class="img-fluid w-100">
					...
					<div class="grid-item mb-6 px-3">
						<div class="itemCol">
							<div class="position-relative">
								<img src="https://placehold.it/410x410" alt="image description" class="img-fluid w-100">
								<div class="hoverTextBlock position-absolute">
					...
					<div class="grid-item grid-item2 mb-6 px-3">
						<div class="itemCol">
							<div class="position-relative">
								<img src="https://placehold.it/845x410" alt="image description" class="img-fluid w-100">
								<div class="hoverTextBlock position-absolute">
			...
			<div class="container-fluid px-xl-20 px-lg-10">
				<!-- testimonailBlock -->
				<section class="testimonailBlock bgCover py-xl-24 py-lg-20 py-md-16 py-10" style="background-image: url(https://placehold.it/1720x560)">
						...
						<div class="newsPostColumn text-center px-2 pb-6 mb-6">
							<div class="imgHolder position-relative mb-6">
								<a href="blog-detail.html">
									<img src="https://placehold.it/370x250" alt="image description" class="img-fluid w-100">
