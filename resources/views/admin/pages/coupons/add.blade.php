...
@section('breadcrumb')
{{renderBreadcrumb('Thêm mã giảm giá', [
        ['name' => 'Trang chủ', 'link' => '/'],
...
@section('content')
<form id="coupons-frm" method="POST" action="{{route('admin.coupons.store')}}" name="frm-new">
    @csrf
    <div class="row">
        <div class="col-12 bg-white py-2">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="input-group">
                        ...
                        <input name="name" type="text" value="{{old('name') ?? ''}}" class="form-control {{$errors->has('name') ? 'is-invalid' : ''}}" id="coupon-name" />
                    </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="input-group">
                        ...
                        <input name="value" type="number" max="100" value="{{old('value') ?? 0}}" class="form-control {{$errors->has('value') ? 'is-invalid' : ''}}" id="coupon-value" />
                    </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="input-group">
                        ...
                        <input name="max_discount" type="text" value="{{old('max_discount') ?? ''}}" class="form-control {{$errors->has('max_discount') ? 'is-invalid' : ''}}" id="coupon-max-discount" data-type="currency" />
                    </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="input-group">
                        ...
                        <input name="max_applied" type="number" value="{{old('max_applied') ?? ''}}" class="form-control {{$errors->has('max_applied') ? 'is-invalid' : ''}}" id="coupon-max-applied" />
                    </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <label class="switch">
                        <input type="checkbox" name="status" value="1" id="coupon-status" checked>
