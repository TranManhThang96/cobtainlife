...
@section('content')
<form id="banners-frm" method="POST" action="{{route('admin.banners.store')}}" name="frm-new">
    @csrf
    <div class="row">
        <div class="col-12 bg-white py-2">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="input-group">
                        ...
                        <input name="sort" type="number" value="{{old('sort') ?? 0}}" class="form-control {{$errors->has('sort') ? 'is-invalid' : ''}}" id="banner-sort" />
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <label class="switch">
                        <input type="checkbox" name="status" value="1" id="banner-status" checked>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control" id="banner-html" rows="5" name="html">{{old('html') ?? ''}}</textarea>
