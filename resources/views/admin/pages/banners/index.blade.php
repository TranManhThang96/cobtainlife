...
@section('breadcrumb')
    {{renderBreadcrumb('Danh sách banner', [['name' => 'Trang chủ', 'link' => '/']])}}
@endsection

@section('content')
    <div class="row">
        <div class="col-md-6 col-lg-6">
            <a type="button" class="btn btn-success" href="{{route('admin.banners.create')}}">
                {{'Thêm banner'}}
            </a>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-body p-0">
                    <div class="table-responsive" id="data-table">
                        @include('admin.pages.banners.list')
                    </div>
                </div>
            </div>
        </div>
...
@section('script')
    <script type="text/javascript" src="{{asset('js/admin/cbanners/index.js')}}"></script>
@endsection
