...
@section('content')
    <div class="row">
        <div class="col-md-6 col-lg-6">
            <a type="button" class="btn btn-success" href="{{route('admin.customers.create')}}">
                {{'Thêm khách hàng'}}
            </a>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-body p-0">
                    <div class="table-responsive" id="data-table">
                        @include('admin.pages.customers.list')
                    </div>
                </div>
            </div>
        </div>
...
@section('script')
    <script type="text/javascript" src="{{asset('js/admin/customers/index.js')}}"></script>
@endsection
