...
@section('breadcrumb')
{{renderBreadcrumb('Thêm nhãn hiệu', [
        ['name' => 'Trang chủ', 'link' => '/'],
...
@section('content')
<form id="brand-frm" method="POST" action="{{route('admin.brands.store')}}">
    @csrf
    <div class="row">
        <div class="col-12 bg-white py-2">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input name="name" type="text" value="{{old('name') ?? ''}}" class="form-control {{$errors->has('name') ? 'is-invalid' : ''}}" id="brand-name" />
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="input-group">
                        ...
                        <input name="sort" type="number" value="{{old('sort') ?? 0}}" class="form-control {{$errors->has('sort') ? 'is-invalid' : ''}}" id="brand-sort" />
