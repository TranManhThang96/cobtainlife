...
@section('breadcrumb')
    {{renderBreadcrumb('Danh sách nhãn hiệu', [['name' => 'Trang chủ', 'link' => '/']])}}
@endsection

@section('content')
    <div class="row">
        <div class="col-md-6 col-lg-6">
            <a type="button" class="btn btn-success" href="{{route('admin.brands.create')}}">
                {{'Thêm nhãn hiệu'}}
            </a>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-body p-0">
                    <div class="table-responsive" id="data-table">
                        @include('admin.pages.brands.list')
                    </div>
                </div>
            </div>
        </div>
...
@section('script')
    <script type="text/javascript" src="{{asset('js/admin/brands/index.js')}}"></script>
