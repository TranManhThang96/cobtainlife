...
@section('breadcrumb')
{{renderBreadcrumb('Thêm bài viết', [
        ['name' => 'Trang chủ', 'link' => '/'],
...
@section('content')
<form id="news-frm" method="POST" action="{{route('admin.news.store')}}" name="frm-new">
    @csrf
    <div class="row">
        <div class="col-12 bg-white py-2">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input name="title" type="text" value="{{old('title') ?? ''}}" class="form-control {{$errors->has('title') ? 'is-invalid' : ''}}" id="news-title" />
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control" id="news-description" rows="5" name="description">{{old('description') ?? ''}}</textarea>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="input-group">
                        ...
                        <input name="sort" type="number" value="{{old('sort') ?? 0}}" class="form-control {{$errors->has('sort') ? 'is-invalid' : ''}}" id="news-sort" />
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <label class="switch">
                        <input type="checkbox" name="status" value="1" id="news-status" checked>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <textarea id="editor_content" name="content" rows="30" class="{{$errors->has('content') ? 'invalid-border' : ''}}">{!!  old('content') ?? '' !!}</textarea>
