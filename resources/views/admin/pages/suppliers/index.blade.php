...
@section('breadcrumb')
    {{renderBreadcrumb('Danh sách nhà cung cấp', [['name' => 'Trang chủ', 'link' => '/']])}}
@endsection

@section('content')
    <div class="row">
        <div class="col-md-6 col-lg-6">
            <a type="button" class="btn btn-success" href="{{route('admin.suppliers.create')}}">
                {{'Thêm nhà cung cấp'}}
            </a>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-body p-0">
                    <div class="table-responsive" id="data-table">
                        @include('admin.pages.suppliers.list')
                    </div>
                </div>
            </div>
        </div>
...
@section('script')
    <script type="text/javascript" src="{{asset('js/admin/suppliers/index.js')}}"></script>
