...
@section('breadcrumb')
{{renderBreadcrumb('Thêm nhà cung cấp', [
        ['name' => 'Trang chủ', 'link' => '/'],
...
@section('content')
<form id="supplier-frm" method="POST" action="{{route('admin.suppliers.store')}}" name="frm-new">
    @csrf
    <div class="row">
        <div class="col-12 bg-white py-2">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input name="name" type="text" value="{{old('name') ?? ''}}" class="form-control {{$errors->has('name') ? 'is-invalid' : ''}}" id="supplier-name" />
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="input-group">
                        ...
                        <input name="phone" type="text" value="{{old('phone') ?? ''}}" class="form-control {{$errors->has('phone') ? 'is-invalid' : ''}}" id="supplier-phone" />
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="input-group">
                        ...
                        <input name="url" type="text" value="{{old('url') ?? ''}}" class="form-control {{$errors->has('url') ? 'is-invalid' : ''}}" id="supplier-url" />
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="input-group">
                        ...
                        <input name="email" type="email" value="{{old('email') ?? ''}}" class="form-control {{$errors->has('email') ? 'is-invalid' : ''}}" id="supplier-email" />
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="input-group">
                        ...
                        <input name="address" type="text" value="{{old('address') ?? ''}}" class="form-control {{$errors->has('address') ? 'is-invalid' : ''}}" id="supplier-address" />
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="input-group">
                        ...
                        <input name="sort" type="number" value="{{old('sort') ?? 0}}" class="form-control {{$errors->has('sort') ? 'is-invalid' : ''}}" id="supplier-sort" />
