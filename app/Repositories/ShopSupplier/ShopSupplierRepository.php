...
namespace App\Repositories\ShopSupplier;
...
class ShopSupplierRepository extends RepositoryAbstract implements ShopSupplierRepositoryInterface
{
    /**
     * get model
     * @return string
    ...
    {
        return \App\Models\ShopSupplier::class;
    }
